    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This page doesn't exist in the Akash One ecosystem.
        </p>
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-gradient-brand px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-lg transition-transform hover:scale-105"
          >
            Return home
          </Link>
        </div>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The platform hit a snag loading this view.
        </p>
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center rounded-full bg-gradient-brand px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-lg"
          >
            Try again
          </button>
          <a
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Akash One — Everything You Need. One Platform." },
      {
        name: "description",
        content:
          "Akash One is a unified AI ecosystem for education, healthcare, cloud storage, search and intelligence — one premium platform.",
      },
      { name: "author", content: "Akash One" },
      { property: "og:title", content: "Akash One — Everything You Need. One Platform." },
      {
